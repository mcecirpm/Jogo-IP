...
class Game:
        ...
        for pos, row in enumerate(layout):
            ...
            for value, column in enumerate(row):
                if column == "W":
                    ...
                    chave_pos = (self.sala_atual.x,
                                 self.sala_atual.y, value, pos)
    ...
    def new(self):
        ...
        self.guardioes = pygame.sprite.LayeredUpdates()
    ...
    def tela_como_jogar(self):
        ...
        while voltando:
            ...
            self.screen.blit(titulo, titulo.get_rect(
                center=(WIDTH_TELA//2, 130)))

            for i, linha in enumerate(instrucoes):
                texto = fonte_texto.render(linha, True, WHITE)
                self.screen.blit(texto, texto.get_rect(
                    center=(WIDTH_TELA//2, 165 + i*35)))
    ...
    def tela_final(self, motivo):
        ...
        caminho_bg = os.path.join(
            diretorio_atual, 'assetes', 'sprites', nome_arquivo)
